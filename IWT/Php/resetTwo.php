...
<body>
 ...
 <div class="yo">
  ...
  <div class="dept">
    <label id="lable">Enter New Password </label><input type ='password' id='password' name='password' size='25px'>
  </div>



  <div class="dept">
    <label id ="lable"> Confirm Password </label><input type ='password' id='confirm_password' name='password' size='25px'>
  </div>
